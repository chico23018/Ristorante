		...
		<body>
			...
			<div class="box-form">
				<div class="left">
					<div class="overlay" >
						<h1>Al pomo d'oro</h1>
						<p>Benvenuti nel cuore della nostra cucina, dove ogni piatto e' creato con passione e dedizione.
							Al Pomo d'oro, crediamo che il cibo non sia solo una necessita', ma un'esperienza da gustare
							con tutti i sensi.
						</p>
					</div>
				</div>
